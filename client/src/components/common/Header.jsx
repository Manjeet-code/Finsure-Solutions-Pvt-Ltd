...
import { 
  Bell, User, LogOut, CheckCircle2, AlertTriangle, Info, AlertOctagon, X, CheckCheck, ChevronRight, Menu 
} from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 sticky top-0 z-30 px-3 sm:px-6 flex items-center justify-between shadow-xs">
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <h1 className="text-base sm:text-xl font-bold text-slate-800 tracking-tight truncate">{getPortalTitle()}</h1>
      </div>
